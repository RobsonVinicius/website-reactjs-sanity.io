    ...
    <header className="bg-indigo-600 fixed z-50 w-full">
      <div className="container mx-auto flex justify-between">
        ...
        <div className="inline-flex py-3 px-3 my-6">
          <a href="https://linkedin.com/in/robson-vinicius" target="_blank" rel="noreferrer" className="mr-5 p-3 rounded-full text-white bg-blue-700 hover:text-blue-700 hover:bg-white">
            <FaLinkedinIn style={{ height: 20, width: 20}} />
          </a>
          <a href="https://codepen.com/robsonvinicius" target="_blank" rel="noreferrer" className="mr-5 p-3 rounded-full text-white bg-black hover:text-black hover:bg-white">
            <FaCodepen style={{ height: 20, width: 20}} />
          </a>
          <a href="https://twitter.com/robsonviniciusr" target="_blank" rel="noreferrer" className="p-3 rounded-full text-white bg-blue-400 hover:text-blue-400 hover:bg-white">
